 ...
 * objects.
 * <p>
 * Since the {@code GeneralPath} class descends from the
 * {@link java.awt.geom.Path2D.Float Path2D.Float} class, the
 * {@link Path2DDelegate.Float} must also be added to the {@link XMLEncoder}, in
